...
Fitting formulae for the non-Gaussian cosmic variance term have been provided by \cite{2010A&A...514A..79P}.
...
the super-survey covariance decreases faster. Therefore it is important for
small survey areas \cite{2009ApJ...701..945S}. A rigorous treatment of the
non-Gaussian covariance including super-survey modes is presented in
...
\mk{Todo: super-survey covariance in simulations; look for analytical approaches (renormalization approach)}
