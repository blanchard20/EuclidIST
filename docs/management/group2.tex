...
pk-3 & Including baryonic corrections \\
pk-4 & Including WDM (massive neutrinos) \\
pk-5 & non-GR models \\
\hline\hline
\end{tabular}
...
nz-3 & With catastrophic outliers $f_{\rm out}$, calibration $c_{\rm cal}$ and biases $z_{\rm bias}$, eq.~(\ref{eq:n_of_z_calib}) \\
\hline\hline
\end{tabular}
\bigskip \bigskip
...
\begin{tabular}{ll} \hline\hline
ia-1  & no IA \\
ia-2a & linear IA model \`a la \cite{2004PhRvD..70f3526H,2007NJPh....9..444B,2011A&A...527A..26J} \\
...
\begin{tabular}{ll} \hline\hline
cm-1 & Gaussian cosmic variance  (analytical) \\
...
\begin{tabular}{ll} \hline\hline
lp-1 & Born, Limber, no clustering, shear \\
lp-2 & reduced shear, beyond Limber and Born \\
lp-3 & Including source clustering \\
lp-3 & Relativistic effects, peculiar motions, other exotic higher-order effects \\
\hline\hline
\end{tabular}
\bigskip \bigskip
